...
var SingleChildProto = {
  ...
  kill: function (options, cb) {
    ...
    // If we are not yet killing the child
    if (!this.killingChild) {
      // Mark that we are killing the child
      this.killingChild = true;
    ...
    child.on('close', function cleanupChild () {
      ...
      // Save that the child is killed
      this.killingChild = false;
