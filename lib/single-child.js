...
var SingleChildProto = {
  ...
  restart: function (cb) {
    ...
    console.log('hii4i');
      ...
      that.emit('starting');
      console.log('waa', that.cmd, that.args, that.options);
...
// When the process is leaving, kill all the single children
function slaughterChildren() {
  nimble.each(SINGLE_CHILDREN, function killEachChild (singleChild, cb) {
    // Kill the child
    console.log('exiting');
